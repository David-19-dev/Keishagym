...
// The mark keeps its own colours whatever accent or theme the profile has chosen.

export function Logo({ size = 64, title = 'KeishaGym' }) {
  return (
    <svg className="kg-logo" width={size} height={size} viewBox="0 0 100 100" role="img" aria-label={title}>
...
export function Wordmark({ className = '', style }) {
  return <span className={'wordmark ' + className} style={style}>Keisha<b>Gym</b></span>
}
