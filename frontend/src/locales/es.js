...
export default {
  ...
  "This browser doesn't support passkeys — you can still use KeishaGym locally on this device.": 'Este navegador no admite passkeys — aun así puedes usar KeishaGym localmente en este dispositivo.',
  ...
  'to install KeishaGym as a full-screen app.': 'para instalar KeishaGym como app a pantalla completa.',
  ...
  'Rest-timer alerts, even if KeishaGym is closed.': 'Avisos del temporizador de descanso, incluso con KeishaGym cerrado.',
  ...
  'A small file a friend imports into their own KeishaGym — routines only, none of your workouts or weigh-ins.': 'Un archivo pequeño que un amigo importa en su propio KeishaGym: solo rutinas, ninguno de tus entrenamientos ni pesajes.',
  ...
  'Reload KeishaGym': 'Recargar KeishaGym',
  ...
  "Check your inbox: confirm your email address, then sign in.": "Revisa tu bandeja de entrada: confirma tu correo y luego inicia sesión.",
  ...
  "Your data syncs to your account on every device.": "Tus datos se sincronizan con tu cuenta en todos tus dispositivos.",
  "Delete account": "Eliminar cuenta",
  "Delete your account?": "¿Eliminar tu cuenta?",
  "Your account and all its synced data are deleted for good. This can’t be undone.": "Tu cuenta y todos sus datos sincronizados se eliminan para siempre. No se puede deshacer.",
